    ...
    return (
      <View style = {styles.MainContainer}>
        ...
        <View style= {styles.MainTextBox}>
          <Text style={styles.MainText}> Cari Lokasi Singaraja </Text>
          <Text style={styles.MainText2}> Menyediakan list tempat umum disekitaran Singaraja sesuai kategori </Text>
        </View>

        <View style = { styles.Buttonbox}>
          <TouchableOpacity style={styles.FacebookStyle} activeOpacity={0.5} onPress = { this.navigate2SecondActivity }>
            <Text style={styles.TextStyle}> Cari Lokasi </Text>
